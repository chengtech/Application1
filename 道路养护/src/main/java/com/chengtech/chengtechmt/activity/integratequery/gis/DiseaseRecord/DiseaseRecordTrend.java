...
public class DiseaseRecordTrend extends BaseFragment2 {

    private String url1 = MyConstants.PRE_URL + "mt/integratequery/diseaserecord/listDiseaseRecordTrendEchart.action?";

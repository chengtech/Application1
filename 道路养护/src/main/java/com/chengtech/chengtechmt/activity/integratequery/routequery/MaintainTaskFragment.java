...
import static com.chengtech.chengtechmt.R.id.recyclerView;
import static com.chengtech.chengtechmt.R.id.textview;
...
public class MaintainTaskFragment extends BaseFragment implements OnItemClickListener {
...
//        textView.setLayoutParams(lp);
    ...
    public MaintainTaskFragment() {
//        url = MyConstants.PRE_URL+"mt/integratequery/gisvisualization/listMaintainTaskInGisJson.action?" +
//                "taskMark=0&subState=1&routeId=";
        url = MyConstants.PRE_URL + "mt/integratequery/basicdataquery/routedataquery/listMaintainTaskJson.action?" +
                "taskMark=0&subState=1&routeId=";
    }
...
//                new RecycleViewAdapter2(getContext(), titleArrayList3, R.layout.item_recycle3);

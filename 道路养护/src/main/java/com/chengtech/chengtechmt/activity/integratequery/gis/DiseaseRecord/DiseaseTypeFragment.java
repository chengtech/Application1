...
/**
 * 作者: LiuFuYingWang on 2018/1/24 15:02.
 * 病害类型统计
 */

public class DiseaseTypeFragment extends BaseFragment2 {
    private String url1 = MyConstants.PRE_URL + "mt/integratequery/diseaserecord/diseaseTypeEcharts.action?";

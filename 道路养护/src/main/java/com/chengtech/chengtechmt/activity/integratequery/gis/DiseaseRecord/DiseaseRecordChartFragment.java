...
public class DiseaseRecordChartFragment extends BaseFragment2 {

    private String url1 = MyConstants.PRE_URL + "mt/integratequery/diseaserecord/indexSmallDiseaseRecordMapEchart.action?";

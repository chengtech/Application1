...
public class CapitalConstructionFragment extends BaseFragment2 {
    private String url1 = MyConstants.PRE_URL + "mt/integratequery/maintenancesituation/routeCodeCapitalEchart.action?";

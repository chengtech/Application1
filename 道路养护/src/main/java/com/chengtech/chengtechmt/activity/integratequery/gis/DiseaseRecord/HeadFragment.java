...
public class HeadFragment extends BaseFragment2 {
//    String url1 = MyConstants.PRE_URL + "mt/integratequery/diseaserecord/indexSmallDiseaseRecordMapEchart.action?";
    String url2 = MyConstants.PRE_URL + "mt/integratequery/diseaserecord/getDiseaseRecordPositionMap.action?";
                        ...
                        if (jsonArray.length() > 0) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                if(snippet.contains("red")) {
                                    iconId = R.mipmap.red;
                                }else if (snippet.contains("blue")) {
                                    iconId = R.mipmap.blue;
                                }else if (snippet.contains("green")) {
                                    iconId = R.mipmap.green;
                                }
                                if (snippet.contains("病害名称"))
                                    snippet = snippet.substring(snippet.indexOf("\"病害名称"), snippet.indexOf("\"icon"));

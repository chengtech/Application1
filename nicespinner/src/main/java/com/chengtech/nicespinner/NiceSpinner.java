package com.chengtech.nicespinner;
    ...
    public void setSelectedIndex(int position) {
        if (adapter != null) {
            if (position >= 0 && position <= adapter.getCount()) {
                ...
                // TODO: 2016/11/17
                if (onItemSelectedListener!=null){
                    onItemSelectedListener.onItemSelected(listView, listView.getChildAt(selectedIndex),
...
//        popupWindow.setHeight(600);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        float v = displayMetrics.density * 300 + 0.5f;
        popupWindow.setWidth(MeasureSpec.getSize(widthMeasureSpec));
        popupWindow.setHeight(WindowManager.LayoutParams.WRAP_CONTENT);
//        popupWindow.setHeight(MeasureSpec.getSize(heightMeasureSpec)*3);
